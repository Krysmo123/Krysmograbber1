...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title("krysmo Grabber Builder")
        ...
        self.font = "Supernova"
        self.iconpath = None
        self.iconbitmap(f"{image_path}krysmo.ico")
    ...
    def get_config(self):
        try:
            with open(self.basefilepath + "\\lkrysmo.py", 'r', encoding="utf-8") as f:
                code = f.read()
            ...
            if config_match:
                ...
                raise Exception("Could not find config in krysmo.py")
